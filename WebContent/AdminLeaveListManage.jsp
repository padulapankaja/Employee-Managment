						...
						<table class="table table-striped " style="font-size: 1.1em">
							...
							<tbody>
								<% int count = 0;
									...
									ArrayList<Leave> arrayList = leaveService.getLeavesList("Pending");
								...
								<tr>
									...
									<td>
										<form method="GET" action="">
											<input type="hidden" name="Index" value="<%=count++%>"></input>
...
<!-- ------------------------------------------------------------------------------------------------------------------------------------ -->
				...
				<div class="col-xs-9"  style="padding: 0px 0px 12px 0px;">	
					...
					<h6>From : <%=leave.getStartDate()%> &nbsp To : <%=leave.getEndDate() %></h6> 
                     ...
                     <textarea class="form-control" rows="3" id="comment" name="feedback"></textarea><br>
					<button class="btn btn-sm " style="background-color : #2ecc71;color : white;" name="action" type="submit" value="Accept"><b>Accept</b></button>
					<button class="btn btn-sm btn-danger" name="action" type="submit" value="Reject"><b>Reject</b></button>
					</form>
					</div>
					</div>
					<%} %>
