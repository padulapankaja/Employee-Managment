						...
						<table class="table table-striped " style="font-size: 1.1em">
							...
							<tbody>
								<% int count = 0;
									...
									ArrayList<Leave> arrayList = leaveService.getLeavesList("All");
								...
								<tr>
									...
									<td><a href="AdminLeaveList.jsp?Index=<%=count++%>">
...
<!-- ------------------------------------------------------------------------------------------------------------------------------------ -->
				...
				<div class="col-xs-9"  style="padding: 0px 0px 12px 0px;">	
					...
					<span class="btn btn-sm btn-danger" name="action" type="submit" value="Reject"><b>Rejected</b></span>
					<%}else{ %>
					<span class="btn btn-sm " style="background-color : #2ecc71;color : white;" name="action" type="submit" value="Accept"><b>Accepted</b></span>
					<%} %>
					</div>
					</div>
					<%} %>
